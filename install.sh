...
curl -s https://raw.githubusercontent.com/aliresaam/new/master/default.json > config.json
...
json=$(curl -s https://raw.githubusercontent.com/aliresaam/new/master/config.json)
